...
def run_pipeline_intent(validated):
    app = build_app()
...
#     prompt = "go to pallet ,move to north 200 m then turn right move 300 m,then go to equipment"
#     validated=dict()
#     validated["user_id"]=1
#     validated["org_id"]=1
#     validated["site_id"]=1
...
#     def return_ids(validated):
#         org_id=validated["org_id"]
#         site_id=validated["site_id"]
#         user_id=validated["user_id"]

#         return org_id,site_id,user_id
#     print("validated_earlier",validated)
